...
import { FolderType, InitialStateProps, RootFolderType } from '../types'

export const ROOT_FOLDER: RootFolderType = { name: 'Drive', id: null, path: [] }
...
export default function useFolder(
  ...
  }, [folderId, currentUser, setLoading])
