...
export default function Trash() {
  ...
  const trashFiles = allFiles.filter((file: any) => file.isTrashed === true);
  const trashFolders = allFolders.filter(
    (folder: any) => folder.isTrashed === true
  );
  ...
  const emptyTrashFolders = () => {
    trashFolders.forEach((folder: any) => {
        ...
        <div>
          ...
          {trashFiles.length <= 0 && trashFolders.length <= 0 ? (
            ...
            <div className='trash-view'>
              ...
              {trashFolders.map((itemTrash: any) => (
