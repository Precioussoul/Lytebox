...
const Section = ({ mode }: modeProps) => {
  return (
    <div className='sectionOne'>
      <div data-aos='fade-down' className='images-showcase'>
        {mode === 'light' ? (
          <img src='images/hbs-mob.png' alt='Lytebox login' />
        ) : (
          <img src='images/hbs-login-dark.png' alt='Lytebox login' />
        )}
      </div>
      <div data-aos='fade-up' className='text-showcase'>
        ...
        <p className='text-showcase-desc'>
          ...
          intruder accessing your files. Lytebox is secured with multiple layer
